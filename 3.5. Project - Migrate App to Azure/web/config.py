...
class BaseConfig:
    ...
    SERVICE_BUS_CONNECTION_STRING = 'Endpoint=sb://techconfservicebus.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=UJuyMB3c8pBFDFMppCxakmBf0uKE7t/vmcjDrldJuZY='  # TODO: Update value
