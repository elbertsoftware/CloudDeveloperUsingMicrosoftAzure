...
def new_post():
    ...
    if form.validate_on_submit():
        ...
        # TODO: Add log to indicate new post created
        app.logger.info(f'New post created, title: {post.title}')
...
def post(id):
    ...
    if form.validate_on_submit():
        ...
        # TODO: Add log to indicate existing post successfully updated
        app.logger.info(
            f'Existing post successfully updated, title: {post.title}')
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user is None or not user.check_password(form.password.data):
            # TODO: Add log to indicate user failed to login
            app.logger.error(
                f'Invalid username or password: {form.username.data}')
        ...
        # TODO: Add log to indicate user was successfully logged in
        app.logger.info(
            f'User has been logged in via web form: {user.username}')
...
def authorized():
    ...
    if request.args.get('code'):
        ...
        # TODO: Add log to indicate sign in with microsoft was successful
        app.logger.info(
            f'User has been logged in via MSAL: {session["user"]}')
